...
description: >
    NPS Feedback System — Smoke Test. Collect and act on Net Promoter Score feedback to identify
...
## Overview
NPS Feedback System — Smoke Test. Collect and act on Net Promoter Score feedback to identify promoters and detractors for targeted follow-up.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** ≥40% response
...
Run the `threshold-engine` drill to measure against: ≥40% response. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
