...
description: >
    Champion Recognition Program — Smoke Test. Identify and empower community leaders with exclusive
  access, recognition, and co-marketing opportunities.
stage: "Product > Referrals"
motion: "Lead Capture Surface"
channels: "Product, Email, Social"
level: "Smoke Test"
time: "5 hours over 1 week"
outcome: "ID 10 champions"
...
## Overview
Champion Recognition Program — Smoke Test. Identify and empower community leaders with exclusive access, recognition, and co-marketing opportunities.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** ID 10 champions
...
Run the `threshold-engine` drill to measure against: ID 10 champions. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
