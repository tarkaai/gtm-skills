...
description: >
    Referral Rewards Program — Smoke Test. Rewards for successful referrals to drive word-of-mouth
  growth.
...
Run the `threshold-engine` drill to measure against: ≥8% refer. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
