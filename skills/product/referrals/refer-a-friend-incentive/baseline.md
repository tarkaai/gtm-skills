...
description: >
    Referral Rewards Program — Baseline Run. Rewards for successful referrals to drive word-of-mouth
  growth.
...
Run the `posthog-gtm-events` drill to set up detailed tracking: `refer-a-friend-incentive_impression`, `refer-a-friend-incentive_engaged`, `refer-a-friend-incentive_converted`, `refer-a-friend-incentive_retained`. Build PostHog funnels showing the complete user journey through this experience.
...
Measure against: ≥12% refer, ≥35% convert. If PASS, proceed to Scalable. If FAIL, diagnose where users are dropping off and test fixes at that specific point.
