...
description: >
    Built-In Social Sharing — Smoke Test. Built-in sharing to amplify reach and drive viral growth
...
Run the `threshold-engine` drill to measure against: ≥20% share. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
