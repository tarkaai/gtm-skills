...
description: >
    Systematic Testimonial Collection — Smoke Test. Systematic collection of customer testimonials
...
## Overview
Systematic Testimonial Collection — Smoke Test. Systematic collection of customer testimonials for website, sales, and marketing use.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** ≥10 testimonials
...
Run the `threshold-engine` drill to measure against: ≥10 testimonials. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
