...
description: >
    Power User Identification — Scalable Automation. Identify and nurture power users with advanced
...
## Overview
Power User Identification — Scalable Automation. Identify and nurture power users with advanced features, exclusive access, and community recognition.

**Time commitment:** 60 hours over 2 months
**Pass threshold:** ≥50 power users at 500+
...
Measure against: ≥50 power users at 500+. If PASS, proceed to Durable. If FAIL, focus on the highest-impact experiment and iterate.
