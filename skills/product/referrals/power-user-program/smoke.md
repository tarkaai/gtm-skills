...
description: >
    Power User Identification — Smoke Test. Identify and nurture power users with advanced features,
  exclusive access, and community recognition.
...
Run the `threshold-engine` drill to measure against: ID top 10%. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
