...
description: >
    G2/Capterra Review Requests — Smoke Test. Ask happy users for G2/Capterra reviews at optimal
...
## Overview
G2/Capterra Review Requests — Smoke Test. Ask happy users for G2/Capterra reviews at optimal moments to build social proof.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** ≥10 reviews
...
Run the `threshold-engine` drill to measure against: ≥10 reviews. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
