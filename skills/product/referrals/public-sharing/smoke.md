...
description: >
    Branded Public Sharing — Smoke Test. Allow users to share work publicly with branding to drive
...
## Overview
Branded Public Sharing — Smoke Test. Allow users to share work publicly with branding to drive awareness and signups.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** ≥25% share publicly
...
Run the `threshold-engine` drill to measure against: ≥25% share publicly. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
