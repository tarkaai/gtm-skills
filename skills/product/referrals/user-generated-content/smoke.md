...
description: >
    UGC Campaign — Smoke Test. Encourage users to create content about product (tutorials, reviews,
  use cases) and amplify their reach.
...
Run the `threshold-engine` drill to measure against: ≥5 UGC pieces. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
