...
description: >
    Incentivized Referral Program — Durable Intelligence. Incentivize users to refer others with
...
outcome: "Sustained or improving referrals ≥8% over 6 months via AI"
kpis: ["Referral rate", "Referee conversion", "Referral CAC", "Experiment velocity", "AI lift"]
...
## Overview
Incentivized Referral Program — Durable Intelligence. Incentivize users to refer others with rewards for both referrer and referee.

**Time commitment:** 150 hours over 6 months
**Pass threshold:** Sustained or improving referrals ≥8% over 6 months via AI
...
Measure against: Sustained or improving referrals ≥8% over 6 months via AI. This level runs continuously. If product metrics sustain or improve, the play is durable. If metrics decay, the agent diagnoses the cause and recommends interventions.
...
## Pass threshold
**Sustained or improving referrals ≥8% over 6 months via AI**
