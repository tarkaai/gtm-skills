...
description: >
    Incentivized Referral Program — Smoke Test. Incentivize users to refer others with rewards for
...
## Overview
Incentivized Referral Program — Smoke Test. Incentivize users to refer others with rewards for both referrer and referee.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** ≥5% refer
...
Run the `threshold-engine` drill to measure against: ≥5% refer. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
