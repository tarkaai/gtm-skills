...
description: >
    At-Risk User Outreach — Baseline Run. Proactive outreach to users showing churn signals with
...
Run the `posthog-gtm-events` drill to set up detailed tracking: `at-risk-intervention_impression`, `at-risk-intervention_engaged`, `at-risk-intervention_converted`, `at-risk-intervention_retained`. Build PostHog funnels showing the complete user journey through this experience.
...
Measure against: ≥40% respond, ≥25% save. If PASS, proceed to Scalable. If FAIL, diagnose where users are dropping off and test fixes at that specific point.
