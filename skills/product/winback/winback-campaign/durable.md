...
description: >
    Churned User Win-back — Durable Intelligence. Re-engage churned users with new offers, features,
...
outcome: "Sustained or improving reactivation ≥12% over 6 months via AI"
...
## Overview
Churned User Win-back — Durable Intelligence. Re-engage churned users with new offers, features, and personalized outreach to drive reactivation.

**Time commitment:** 150 hours over 6 months
**Pass threshold:** Sustained or improving reactivation ≥12% over 6 months via AI
...
Measure against: Sustained or improving reactivation ≥12% over 6 months via AI. This level runs continuously. If product metrics sustain or improve, the play is durable. If metrics decay, the agent diagnoses the cause and recommends interventions.
...
## Pass threshold
**Sustained or improving reactivation ≥12% over 6 months via AI**
