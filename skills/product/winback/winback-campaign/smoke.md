...
description: >
    Churned User Win-back — Smoke Test. Re-engage churned users with new offers, features, and
...
## Overview
Churned User Win-back — Smoke Test. Re-engage churned users with new offers, features, and personalized outreach to drive reactivation.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** ≥10% reactivate
...
Run the `threshold-engine` drill to measure against: ≥10% reactivate. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
