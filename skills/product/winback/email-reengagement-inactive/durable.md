...
description: >
    Inactive User Re-engagement — Durable Intelligence. Automated email sequences to win back users
...
Measure against: Sustained or improving return ≥18% over 6 months via AI. This level runs continuously. If product metrics sustain or improve, the play is durable. If metrics decay, the agent diagnoses the cause and recommends interventions.
