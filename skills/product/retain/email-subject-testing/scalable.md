...
description: >
    Email Campaign A/B Tests — Scalable Automation. A/B test email campaigns to improve open rates,
  CTR, and conversion.
...
## Overview
Email Campaign A/B Tests — Scalable Automation. A/B test email campaigns to improve open rates, CTR, and conversion.

**Time commitment:** 60 hours over 2 months
**Pass threshold:** ≥15% lift at 500+
...
Measure against: ≥15% lift at 500+. If PASS, proceed to Durable. If FAIL, focus on the highest-impact experiment and iterate.
