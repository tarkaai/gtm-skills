...
description: >
    Email Campaign A/B Tests — Durable Intelligence. A/B test email campaigns to improve open rates,
  CTR, and conversion.
...
kpis: ["Open rate", "CTR", "Conversion rate", "Experiment velocity", "AI lift"]
...
drills:
  ...
  - nps-feedback-loop
---
# Email Campaign A/B Tests — Durable Intelligence

> **Stage:** Product → Retain | **Motion:** Lead Capture Surface | **Channels:** Email

## Overview
Email Campaign A/B Tests — Durable Intelligence. A/B test email campaigns to improve open rates, CTR, and conversion.
