...
description: >
    CS Intervention Playbooks — Smoke Test. Document repeatable CS interventions for common churn
...
Run the `threshold-engine` drill to measure against: 5 playbooks created. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
