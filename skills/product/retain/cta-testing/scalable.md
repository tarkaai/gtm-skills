...
description: >
    CTA Optimization — Scalable Automation. Test different calls-to-action in product to maximize
...
Measure against: ≥20% lift at 500+. If PASS, proceed to Durable. If FAIL, focus on the highest-impact experiment and iterate.
