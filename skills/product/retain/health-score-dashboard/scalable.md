...
description: >
    Account Health Scoring — Scalable Automation. Track account health across multiple dimensions
...
outcome: "≥75% accuracy at 500+"
kpis: ["Score accuracy", "Health correlation", "Predictive value", "Segment metrics"]
...
## Overview
Account Health Scoring — Scalable Automation. Track account health across multiple dimensions (usage, engagement, support) to identify expansion and churn risk.

**Time commitment:** 60 hours over 2 months
**Pass threshold:** ≥75% accuracy at 500+
...
Measure against: ≥75% accuracy at 500+. If PASS, proceed to Durable. If FAIL, focus on the highest-impact experiment and iterate.
