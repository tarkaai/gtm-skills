...
description: >
    Holdout Group Analysis — Scalable Automation. Maintain control groups to measure cumulative
...
outcome: "≥12% lift at 500+"
kpis: ["Holdout performance", "Cumulative lift", "Long-term impact", "Segment metrics"]
slug: "holdout-groups"
...
## Overview
Holdout Group Analysis — Scalable Automation. Maintain control groups to measure cumulative impact of experiments over time.

**Time commitment:** 60 hours over 2 months
**Pass threshold:** ≥12% lift at 500+
...
Measure against: ≥12% lift at 500+. If PASS, proceed to Durable. If FAIL, focus on the highest-impact experiment and iterate.
