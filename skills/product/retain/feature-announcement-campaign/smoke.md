...
description: >
    New Feature Announcements — Smoke Test. Multi-channel campaigns (in-app, email, social)
...
## Overview
New Feature Announcements — Smoke Test. Multi-channel campaigns (in-app, email, social) announcing new features to drive awareness and trial among existing users.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** ≥25% try in 7d
...
Run the `threshold-engine` drill to measure against: ≥25% try in 7d. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
