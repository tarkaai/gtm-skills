...
description: >
    AI-Powered Recommendations — Smoke Test. In-product recommendations powered by AI to drive
...
## Overview
AI-Powered Recommendations — Smoke Test. In-product recommendations powered by AI to drive feature discovery and engagement.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** ≥35% accept recs
...
Run the `threshold-engine` drill to measure against: ≥35% accept recs. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
