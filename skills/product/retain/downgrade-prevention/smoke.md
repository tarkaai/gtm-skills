...
description: >
    Downgrade Intervention — Smoke Test. Retain users considering downgrade with personalized
...
Run the `threshold-engine` drill to measure against: ≥40% prevent. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
