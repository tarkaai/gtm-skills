...
description: >
    AI In-App Support — Scalable Automation. AI-powered in-app support to answer questions and
...
## Overview
AI In-App Support — Scalable Automation. AI-powered in-app support to answer questions and resolve issues quickly.

**Time commitment:** 60 hours over 2 months
**Pass threshold:** ≥55% use at 500+
...
Measure against: ≥55% use at 500+. If PASS, proceed to Durable. If FAIL, focus on the highest-impact experiment and iterate.
