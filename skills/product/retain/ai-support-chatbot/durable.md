...
description: >
    AI In-App Support — Durable Intelligence. AI-powered in-app support to answer questions and
...
outcome: "Sustained or improving usage ≥55% over 6 months via AI"
kpis: ["Chatbot usage", "Resolution rate", "Satisfaction score", "Experiment velocity", "AI lift"]
...
## Overview
AI In-App Support — Durable Intelligence. AI-powered in-app support to answer questions and resolve issues quickly.

**Time commitment:** 150 hours over 6 months
**Pass threshold:** Sustained or improving usage ≥55% over 6 months via AI
...
Measure against: Sustained or improving usage ≥55% over 6 months via AI. This level runs continuously. If product metrics sustain or improve, the play is durable. If metrics decay, the agent diagnoses the cause and recommends interventions.
...
## Pass threshold
**Sustained or improving usage ≥55% over 6 months via AI**
