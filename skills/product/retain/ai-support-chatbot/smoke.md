...
description: >
    AI In-App Support — Smoke Test. AI-powered in-app support to answer questions and resolve issues
  quickly.
...
## Overview
AI In-App Support — Smoke Test. AI-powered in-app support to answer questions and resolve issues quickly.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** ≥50% use chatbot
...
Run the `threshold-engine` drill to measure against: ≥50% use chatbot. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
