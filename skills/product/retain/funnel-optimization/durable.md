...
description: >
    Conversion Funnel Optimization — Durable Intelligence. Optimize key user funnels (signup,
  activation, upgrade) through analysis and experimentation.
stage: "Product > Retain"
motion: "Lead Capture Surface"
channels: "Product"
level: "Durable Intelligence"
time: "150 hours over 6 months"
outcome: "Sustained or improving improvement sustained over 6 months via AI"
kpis: ["Funnel conversion", "Drop-off reduction", "Test velocity", "Experiment velocity", "AI lift"]
...
## Overview
Conversion Funnel Optimization — Durable Intelligence. Optimize key user funnels (signup, activation, upgrade) through analysis and experimentation.

**Time commitment:** 150 hours over 6 months
**Pass threshold:** Sustained or improving improvement sustained over 6 months via AI
...
Measure against: Sustained or improving improvement sustained over 6 months via AI. This level runs continuously. If product metrics sustain or improve, the play is durable. If metrics decay, the agent diagnoses the cause and recommends interventions.
...
## Pass threshold
**Sustained or improving improvement sustained over 6 months via AI**
...
_Install this skill: `npx gtm-skills add product/retain/funnel-optimization`_
