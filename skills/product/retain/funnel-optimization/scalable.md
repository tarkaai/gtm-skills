...
description: >
    Conversion Funnel Optimization — Scalable Automation. Optimize key user funnels (signup,
...
outcome: "≥15% at 500+"
kpis: ["Funnel conversion", "Drop-off reduction", "Test velocity", "Segment metrics"]
...
drills:
  ...
  - upgrade-prompt
---
# Conversion Funnel Optimization — Scalable Automation

> **Stage:** Product → Retain | **Motion:** Lead Capture Surface | **Channels:** Product

## Overview
Conversion Funnel Optimization — Scalable Automation. Optimize key user funnels (signup, activation, upgrade) through analysis and experimentation.
...
Measure against: ≥15% at 500+. If PASS, proceed to Durable. If FAIL, focus on the highest-impact experiment and iterate.
