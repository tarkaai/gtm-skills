...
description: >
    AI Behavior Segmentation — Smoke Test. Use AI to segment users by behavior patterns for
...
Run the `threshold-engine` drill to measure against: 5 AI segments. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
