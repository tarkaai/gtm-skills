...
description: >
    Product A/B Testing — Durable Intelligence. Systematic approach to testing features, UX, and
  messaging in PostHog to drive continuous improvement.
stage: "Product > Retain"
motion: "Lead Capture Surface"
channels: "Product"
level: "Durable Intelligence"
time: "150 hours over 6 months"
outcome: "Sustained or improving experiments continuous over 6 months via AI"
...
## Overview
Product A/B Testing — Durable Intelligence. Systematic approach to testing features, UX, and messaging in PostHog to drive continuous improvement.

**Time commitment:** 150 hours over 6 months
**Pass threshold:** Sustained or improving experiments continuous over 6 months via AI
...
Measure against: Sustained or improving experiments continuous over 6 months via AI. This level runs continuously. If product metrics sustain or improve, the play is durable. If metrics decay, the agent diagnoses the cause and recommends interventions.
...
## Pass threshold
**Sustained or improving experiments continuous over 6 months via AI**
