...
description: >
    Targeted Adoption Campaigns — Smoke Test. Coordinated campaigns to drive adoption of specific
...
## Overview
Targeted Adoption Campaigns — Smoke Test. Coordinated campaigns to drive adoption of specific features with segmented messaging, tutorials, and incentives.
...
Run the `threshold-engine` drill to measure against: ≥20% adopt. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
