...
description: >
    Weekly Feature Spotlights — Smoke Test. Regular highlights of powerful but underused features
...
## Overview
Weekly Feature Spotlights — Smoke Test. Regular highlights of powerful but underused features via email and in-app to drive discovery and adoption.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** ≥20% try
...
Run the `threshold-engine` drill to measure against: ≥20% try. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
