...
description: >
    Weekly Feature Spotlights — Baseline Run. Regular highlights of powerful but underused features
  via email and in-app to drive discovery and adoption.
...
Run the `posthog-gtm-events` drill to set up detailed tracking: `feature-spotlight-series_impression`, `feature-spotlight-series_engaged`, `feature-spotlight-series_converted`, `feature-spotlight-series_retained`. Build PostHog funnels showing the complete user journey through this experience.
...
Measure against: ≥30% trial, ≥10% sustained. If PASS, proceed to Scalable. If FAIL, diagnose where users are dropping off and test fixes at that specific point.
