...
description: >
    Feature Sunset Communication — Durable Intelligence. Sunset old features without losing users
...
outcome: "Sustained or improving migration ≥85% over 6 months via AI"
...
## Overview
Feature Sunset Communication — Durable Intelligence. Sunset old features without losing users through clear communication and migration paths.

**Time commitment:** 150 hours over 6 months
**Pass threshold:** Sustained or improving migration ≥85% over 6 months via AI
...
Measure against: Sustained or improving migration ≥85% over 6 months via AI. This level runs continuously. If product metrics sustain or improve, the play is durable. If metrics decay, the agent diagnoses the cause and recommends interventions.
...
## Pass threshold
**Sustained or improving migration ≥85% over 6 months via AI**
