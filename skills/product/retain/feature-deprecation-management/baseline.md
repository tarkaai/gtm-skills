...
description: >
    Feature Sunset Communication — Baseline Run. Sunset old features without losing users through
...
Run the `posthog-gtm-events` drill to set up detailed tracking: `feature-deprecation-management_impression`, `feature-deprecation-management_engaged`, `feature-deprecation-management_converted`, `feature-deprecation-management_retained`. Build PostHog funnels showing the complete user journey through this experience.
...
Measure against: ≥90% migrate, <5% churn. If PASS, proceed to Scalable. If FAIL, diagnose where users are dropping off and test fixes at that specific point.
