...
description: >
    Feature Sunset Communication — Smoke Test. Sunset old features without losing users through
...
## Overview
Feature Sunset Communication — Smoke Test. Sunset old features without losing users through clear communication and migration paths.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** ≥80% migrate
...
Run the `threshold-engine` drill to measure against: ≥80% migrate. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
