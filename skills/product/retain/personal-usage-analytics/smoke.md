...
description: >
    User Self-Service Analytics — Smoke Test. Show users their own usage data and insights to
...
## Overview
User Self-Service Analytics — Smoke Test. Show users their own usage data and insights to increase engagement and demonstrate product value.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** ≥50% view
...
Run the `threshold-engine` drill to measure against: ≥50% view. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
