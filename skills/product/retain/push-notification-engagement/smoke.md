...
description: >
    Push Notification Strategy — Smoke Test. Mobile and browser push notifications for
...
Run the `threshold-engine` drill to measure against: ≥25% CTR. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
