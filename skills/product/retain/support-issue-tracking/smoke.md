...
description: >
    Support Ticket Churn Signals — Smoke Test. Monitor support tickets as leading churn indicator;
...
outcome: "Track ticket correlation"
...
## Overview
Support Ticket Churn Signals — Smoke Test. Monitor support tickets as leading churn indicator; trigger CS outreach for high-ticket accounts.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** Track ticket correlation
...
Run the `threshold-engine` drill to measure against: Track ticket correlation. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
