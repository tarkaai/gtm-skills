...
description: >
    AI Churn Prediction — Smoke Test. Use PostHog data to build machine learning model predicting
...
## Overview
AI Churn Prediction — Smoke Test. Use PostHog data to build machine learning model predicting churn risk for proactive intervention.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** Predict top 20% at risk
...
Run the `threshold-engine` drill to measure against: Predict top 20% at risk. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
