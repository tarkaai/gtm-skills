...
description: >
    AI Churn Prediction — Durable Intelligence. Use PostHog data to build machine learning model
...
outcome: "Sustained or improving churn reduction sustained over 6 months via AI"
...
## Overview
AI Churn Prediction — Durable Intelligence. Use PostHog data to build machine learning model predicting churn risk for proactive intervention.

**Time commitment:** 150 hours over 6 months
**Pass threshold:** Sustained or improving churn reduction sustained over 6 months via AI
...
Measure against: Sustained or improving churn reduction sustained over 6 months via AI. This level runs continuously. If product metrics sustain or improve, the play is durable. If metrics decay, the agent diagnoses the cause and recommends interventions.
...
## Pass threshold
**Sustained or improving churn reduction sustained over 6 months via AI**
