...
Run the `threshold-engine` drill to measure against: ≥60% see message. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
