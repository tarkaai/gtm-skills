...
description: >
    Habit-Building Features — Scalable Automation. Design features to create daily/weekly habits
...
## Overview
Habit-Building Features — Scalable Automation. Design features to create daily/weekly habits through streaks, reminders, and routine-based workflows.

**Time commitment:** 60 hours over 2 months
**Pass threshold:** ≥35% DAU at 500+
...
Measure against: ≥35% DAU at 500+. If PASS, proceed to Durable. If FAIL, focus on the highest-impact experiment and iterate.
