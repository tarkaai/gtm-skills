...
description: >
    Multivariate Experiments — Smoke Test. Test multiple variables simultaneously to find optimal
  combinations faster.
...
## Overview
Multivariate Experiments — Smoke Test. Test multiple variables simultaneously to find optimal combinations faster.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** Run 2 MVTs
...
Run the `threshold-engine` drill to measure against: Run 2 MVTs. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
