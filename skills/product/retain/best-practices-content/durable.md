...
description: >
    In-App Best Practices — Durable Intelligence. Educate users on optimal product usage with
...
outcome: "Sustained or improving engagement ≥40% over 6 months via AI"
...
## Overview
In-App Best Practices — Durable Intelligence. Educate users on optimal product usage with contextual best practices, tips, and workflow suggestions.

**Time commitment:** 150 hours over 6 months
**Pass threshold:** Sustained or improving engagement ≥40% over 6 months via AI
...
Measure against: Sustained or improving engagement ≥40% over 6 months via AI. This level runs continuously. If product metrics sustain or improve, the play is durable. If metrics decay, the agent diagnoses the cause and recommends interventions.
...
## Pass threshold
**Sustained or improving engagement ≥40% over 6 months via AI**
