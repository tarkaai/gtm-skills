...
description: >
    In-App Best Practices — Smoke Test. Educate users on optimal product usage with contextual best
  practices, tips, and workflow suggestions.
...
## Overview
In-App Best Practices — Smoke Test. Educate users on optimal product usage with contextual best practices, tips, and workflow suggestions.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** ≥35% engage
...
Run the `threshold-engine` drill to measure against: ≥35% engage. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
