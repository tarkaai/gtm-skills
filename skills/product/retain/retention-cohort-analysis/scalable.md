...
description: >
    Retention Cohort Analytics — Scalable Automation. Analyze retention by cohort to find patterns
...
outcome: "≥5 insights/2mo"
kpis: ["Retention by cohort", "Insight generation", "Action success", "Segment metrics"]
...
## Overview
Retention Cohort Analytics — Scalable Automation. Analyze retention by cohort to find patterns and optimize for different user segments.

**Time commitment:** 60 hours over 2 months
**Pass threshold:** ≥5 insights/2mo
...
Measure against: ≥5 insights/2mo. If PASS, proceed to Durable. If FAIL, focus on the highest-impact experiment and iterate.
