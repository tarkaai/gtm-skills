...
description: >
    Net Retention Focus — Scalable Automation. Focus on reducing churn and increasing expansion to
...
outcome: "NDR ≥115% at 500+"
kpis: ["Net dollar retention", "Churn rate", "Expansion rate", "Segment metrics"]
...
drills:
  ...
  - upgrade-prompt
---
# Net Retention Focus — Scalable Automation

> **Stage:** Product → Retain | **Motion:** Lead Capture Surface | **Channels:** Product, Email

## Overview
Net Retention Focus — Scalable Automation. Focus on reducing churn and increasing expansion to optimize net dollar retention (NDR).

**Time commitment:** 60 hours over 2 months
**Pass threshold:** NDR ≥115% at 500+
...
Measure against: NDR ≥115% at 500+. If PASS, proceed to Durable. If FAIL, focus on the highest-impact experiment and iterate.
