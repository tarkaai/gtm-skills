...
description: >
    Net Retention Focus — Smoke Test. Focus on reducing churn and increasing expansion to optimize
...
Run the `threshold-engine` drill to measure against: NDR baseline >100%. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
