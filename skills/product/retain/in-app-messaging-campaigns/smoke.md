...
description: >
    Behavioral In-App Messages — Smoke Test. Trigger targeted in-app messages based on user behavior
  in PostHog to drive engagement and feature adoption.
...
## Overview
Behavioral In-App Messages — Smoke Test. Trigger targeted in-app messages based on user behavior in PostHog to drive engagement and feature adoption.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** ≥35% CTR
...
Run the `threshold-engine` drill to measure against: ≥35% CTR. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
