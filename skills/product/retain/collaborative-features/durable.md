...
description: >
    Multiplayer Product Features — Durable Intelligence. Multi-user features that drive network
  effects and organic growth through collaboration.
...
kpis: ["Collaboration usage", "Team size", "Retention lift", "Experiment velocity", "AI lift"]
...
## Overview
Multiplayer Product Features — Durable Intelligence. Multi-user features that drive network effects and organic growth through collaboration.
...
Measure against: Sustained or improving usage ≥35% over 6 months via AI. This level runs continuously. If product metrics sustain or improve, the play is durable. If metrics decay, the agent diagnoses the cause and recommends interventions.
