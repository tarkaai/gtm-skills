...
description: >
    AI Content Assistant — Smoke Test. Help users create content with AI to increase product value
  and stickiness.
...
Run the `threshold-engine` drill to measure against: ≥30% use AI. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
