...
description: >
    AI Workflow Recommendations — Smoke Test. Use AI to analyze user behavior and suggest workflow
...
## Overview
AI Workflow Recommendations — Smoke Test. Use AI to analyze user behavior and suggest workflow improvements and efficiency gains.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** ≥30% act
...
Run the `threshold-engine` drill to measure against: ≥30% act. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
