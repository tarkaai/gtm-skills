...
description: >
    Onboarding email sequence — Scalable Automation. Automated email sequence for new signups to
...
Measure against: Early retention ≥ 40% sustained over 2 months. If PASS, proceed to Durable. If FAIL, focus on the highest-impact experiment and iterate.
