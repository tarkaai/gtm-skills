...
description: >
    Quick Start Documentation — Scalable Automation. Create concise, scannable quick-start guide
...
## Overview
Quick Start Documentation — Scalable Automation. Create concise, scannable quick-start guide accessible in-app and via email to reduce onboarding friction.
