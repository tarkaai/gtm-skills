...
description: >
    Quick Start Documentation — Durable Intelligence. Create concise, scannable quick-start guide
  accessible in-app and via email to reduce onboarding friction.
...
## Overview
Quick Start Documentation — Durable Intelligence. Create concise, scannable quick-start guide accessible in-app and via email to reduce onboarding friction.
