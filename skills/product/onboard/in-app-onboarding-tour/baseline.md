...
description: >
    Interactive Product Tour — Baseline Run. Interactive in-app tour guiding new users through key
  features and workflows to accelerate time-to-value and increase activation rate.
...
Run the `posthog-gtm-events` drill to set up detailed tracking: `in-app-onboarding-tour_impression`, `in-app-onboarding-tour_engaged`, `in-app-onboarding-tour_converted`, `in-app-onboarding-tour_retained`. Build PostHog funnels showing the complete user journey through this experience.
...
Measure against: ≥50% activation, ≥10pp lift. If PASS, proceed to Scalable. If FAIL, diagnose where users are dropping off and test fixes at that specific point.
