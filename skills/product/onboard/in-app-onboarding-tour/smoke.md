...
description: >
    Interactive Product Tour — Smoke Test. Interactive in-app tour guiding new users through key
...
## Overview
Interactive Product Tour — Smoke Test. Interactive in-app tour guiding new users through key features and workflows to accelerate time-to-value and increase activation rate.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** ≥40% activation in 7d
...
Run the `threshold-engine` drill to measure against: ≥40% activation in 7d. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
