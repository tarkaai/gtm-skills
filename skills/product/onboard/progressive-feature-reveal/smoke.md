...
description: >
    Progressive Feature Discovery — Smoke Test. Reveal advanced features gradually as users master
...
Run the `threshold-engine` drill to measure against: ≥35% use advanced in 14d. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
