...
description: >
    AI Onboarding Assistant — Baseline Run. AI agent that guides onboarding with personalized help
...
Run the `posthog-gtm-events` drill to set up detailed tracking: `ai-onboarding-coach_impression`, `ai-onboarding-coach_engaged`, `ai-onboarding-coach_converted`, `ai-onboarding-coach_retained`. Build PostHog funnels showing the complete user journey through this experience.
...
Measure against: ≥55% use, ≥15pp activation. If PASS, proceed to Scalable. If FAIL, diagnose where users are dropping off and test fixes at that specific point.
