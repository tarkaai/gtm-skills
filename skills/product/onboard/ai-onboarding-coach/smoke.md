...
description: >
    AI Onboarding Assistant — Smoke Test. AI agent that guides onboarding with personalized help and
...
## Overview
AI Onboarding Assistant — Smoke Test. AI agent that guides onboarding with personalized help and proactive suggestions.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** ≥45% use AI coach
...
Run the `threshold-engine` drill to measure against: ≥45% use AI coach. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
