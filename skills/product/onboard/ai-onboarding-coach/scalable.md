...
description: >
    AI Onboarding Assistant — Scalable Automation. AI agent that guides onboarding with personalized
  help and proactive suggestions.
stage: "Product > Onboard"
motion: "Lead Capture Surface"
channels: "Product"
level: "Scalable Automation"
time: "60 hours over 2 months"
outcome: "≥50% use at 500+"
...
## Overview
AI Onboarding Assistant — Scalable Automation. AI agent that guides onboarding with personalized help and proactive suggestions.

**Time commitment:** 60 hours over 2 months
**Pass threshold:** ≥50% use at 500+
...
Measure against: ≥50% use at 500+. If PASS, proceed to Durable. If FAIL, focus on the highest-impact experiment and iterate.
