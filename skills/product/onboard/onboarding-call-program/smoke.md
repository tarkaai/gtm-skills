...
description: >
    High-Touch Onboarding Calls — Smoke Test. Offer personal onboarding calls to high-value users to
  accelerate activation and gather qualitative feedback.
stage: "Product > Onboard"
motion: "Lead Capture Surface"
channels: "Product, Direct"
level: "Smoke Test"
time: "5 hours over 1 week"
outcome: "≥80% activation"
...
## Overview
High-Touch Onboarding Calls — Smoke Test. Offer personal onboarding calls to high-value users to accelerate activation and gather qualitative feedback.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** ≥80% activation
...
Run the `threshold-engine` drill to measure against: ≥80% activation. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
