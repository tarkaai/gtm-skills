...
description: >
    High-Touch Onboarding Calls — Baseline Run. Offer personal onboarding calls to high-value users
  to accelerate activation and gather qualitative feedback.
...
Run the `posthog-gtm-events` drill to set up detailed tracking: `onboarding-call-program_impression`, `onboarding-call-program_engaged`, `onboarding-call-program_converted`, `onboarding-call-program_retained`. Build PostHog funnels showing the complete user journey through this experience.
...
Measure against: ≥85%, ≥25pp. If PASS, proceed to Scalable. If FAIL, diagnose where users are dropping off and test fixes at that specific point.
