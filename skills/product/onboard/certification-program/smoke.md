...
description: >
    Product Certification Program — Smoke Test. Offer certification for users who complete advanced
  training to drive deep product adoption and create advocates.
stage: "Product > Onboard"
motion: "Lead Capture Surface"
channels: "Product, Email, Content"
level: "Smoke Test"
time: "5 hours over 1 week"
outcome: "≥20% start, ≥60% complete"
...
## Overview
Product Certification Program — Smoke Test. Offer certification for users who complete advanced training to drive deep product adoption and create advocates.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** ≥20% start, ≥60% complete
...
Run the `threshold-engine` drill to measure against: ≥20% start, ≥60% complete. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
