...
description: >
    Onboarding A/B Tests — Durable Intelligence. Test different onboarding approaches to maximize
...
kpis: ["Activation lift", "Test velocity", "Winning patterns", "Experiment velocity", "AI lift"]
...
## Overview
Onboarding A/B Tests — Durable Intelligence. Test different onboarding approaches to maximize activation and time-to-value.
