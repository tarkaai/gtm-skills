...
description: >
    Onboarding A/B Tests — Smoke Test. Test different onboarding approaches to maximize activation
  and time-to-value.
...
Run the `threshold-engine` drill to measure against: Test 2 variants. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
