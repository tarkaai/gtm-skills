...
description: >
    Video Tutorial System — Smoke Test. Create and promote short video tutorials for key workflows,
  accessible in-app and via email, to accelerate learning.
...
Run the `threshold-engine` drill to measure against: ≥30% watch in wk1. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
