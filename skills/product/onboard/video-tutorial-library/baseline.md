...
description: >
    Video Tutorial System — Baseline Run. Create and promote short video tutorials for key
...
Run the `posthog-gtm-events` drill to set up detailed tracking: `video-tutorial-library_impression`, `video-tutorial-library_engaged`, `video-tutorial-library_converted`, `video-tutorial-library_retained`. Build PostHog funnels showing the complete user journey through this experience.
...
Measure against: ≥40%, ≥8pp. If PASS, proceed to Scalable. If FAIL, diagnose where users are dropping off and test fixes at that specific point.
