...
description: >
    Activation Event Tracking — Scalable Automation. Define, instrument, and optimize key activation
  events in PostHog to improve product-market fit and retention.
