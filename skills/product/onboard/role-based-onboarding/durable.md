...
description: >
    Persona-Based Onboarding — Durable Intelligence. Tailor onboarding flows, messaging, and
  examples to user role and use case for higher relevance and activation.
stage: "Product > Onboard"
motion: "Lead Capture Surface"
channels: "Product, Email"
level: "Durable Intelligence"
time: "150 hours over 6 months"
outcome: "Sustained or improving activation ≥50% over 6 months via AI"
...
## Overview
Persona-Based Onboarding — Durable Intelligence. Tailor onboarding flows, messaging, and examples to user role and use case for higher relevance and activation.

**Time commitment:** 150 hours over 6 months
**Pass threshold:** Sustained or improving activation ≥50% over 6 months via AI
...
Measure against: Sustained or improving activation ≥50% over 6 months via AI. This level runs continuously. If product metrics sustain or improve, the play is durable. If metrics decay, the agent diagnoses the cause and recommends interventions.
...
## Pass threshold
**Sustained or improving activation ≥50% over 6 months via AI**
