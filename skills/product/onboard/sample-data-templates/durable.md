...
description: >
    Sample Data Acceleration — Durable Intelligence. Pre-populate accounts with sample data and
...
outcome: "Sustained or improving engagement ≥75% over 6 months via AI"
...
## Overview
Sample Data Acceleration — Durable Intelligence. Pre-populate accounts with sample data and templates so users can explore functionality before adding real data.

**Time commitment:** 150 hours over 6 months
**Pass threshold:** Sustained or improving engagement ≥75% over 6 months via AI
...
Measure against: Sustained or improving engagement ≥75% over 6 months via AI. This level runs continuously. If product metrics sustain or improve, the play is durable. If metrics decay, the agent diagnoses the cause and recommends interventions.
...
## Pass threshold
**Sustained or improving engagement ≥75% over 6 months via AI**
