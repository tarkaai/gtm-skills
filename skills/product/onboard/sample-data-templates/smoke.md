...
description: >
    Sample Data Acceleration — Smoke Test. Pre-populate accounts with sample data and templates so
...
Run the `threshold-engine` drill to measure against: ≥70% interact. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
