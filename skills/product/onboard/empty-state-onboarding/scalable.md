...
description: >
    Empty State Guidance — Scalable Automation. Convert empty states into onboarding opportunities
...
outcome: "≥45% at 500+"
kpis: ["Empty state CTR", "Activation rate", "Feature adoption", "Segment metrics"]
...
## Overview
Empty State Guidance — Scalable Automation. Convert empty states into onboarding opportunities with contextual CTAs, examples, and quick-start templates.
