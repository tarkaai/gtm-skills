...
description: >
    Empty State Guidance — Durable Intelligence. Convert empty states into onboarding opportunities
  with contextual CTAs, examples, and quick-start templates.
stage: "Product > Onboard"
motion: "Lead Capture Surface"
channels: "Product"
level: "Durable Intelligence"
time: "150 hours over 6 months"
outcome: "Sustained or improving CTR ≥45% over 6 months via AI"
...
## Overview
Empty State Guidance — Durable Intelligence. Convert empty states into onboarding opportunities with contextual CTAs, examples, and quick-start templates.

**Time commitment:** 150 hours over 6 months
**Pass threshold:** Sustained or improving CTR ≥45% over 6 months via AI
...
Measure against: Sustained or improving CTR ≥45% over 6 months via AI. This level runs continuously. If product metrics sustain or improve, the play is durable. If metrics decay, the agent diagnoses the cause and recommends interventions.
...
## Pass threshold
**Sustained or improving CTR ≥45% over 6 months via AI**
