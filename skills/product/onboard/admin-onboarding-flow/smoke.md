...
description: >
    Admin vs User Onboarding — Smoke Test. Separate onboarding flows for admins (setup,
...
## Overview
Admin vs User Onboarding — Smoke Test. Separate onboarding flows for admins (setup, configuration) and end users (usage, workflows) to optimize each journey.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** ≥60% admin, ≥50% user
...
Run the `threshold-engine` drill to measure against: ≥60% admin, ≥50% user. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
