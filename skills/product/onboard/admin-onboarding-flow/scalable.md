...
description: >
    Admin vs User Onboarding — Scalable Automation. Separate onboarding flows for admins (setup,
...
outcome: "≥65% admin, ≥55% user at 500+"
kpis: ["Admin setup", "User activation", "Team invite rate", "Segment metrics"]
...
## Overview
Admin vs User Onboarding — Scalable Automation. Separate onboarding flows for admins (setup, configuration) and end users (usage, workflows) to optimize each journey.

**Time commitment:** 60 hours over 2 months
**Pass threshold:** ≥65% admin, ≥55% user at 500+
...
Measure against: ≥65% admin, ≥55% user at 500+. If PASS, proceed to Durable. If FAIL, focus on the highest-impact experiment and iterate.
