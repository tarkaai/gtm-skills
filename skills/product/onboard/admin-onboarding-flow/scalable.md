...
## Overview
Separate onboarding flows for admins (setup, configuration) and end users (usage, workflows) to optimize each journey.
...
3. Target: ≥500 users/2mo; efficiency: ≥65% admin, ≥55% user at 500+.
