...
description: >
    PQL Scoring System — Smoke Test. Identify high-intent users for sales outreach based on product
  usage signals.
...
Run the `threshold-engine` drill to measure against: Score top 20%. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
