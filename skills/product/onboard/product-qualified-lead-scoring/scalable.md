...
description: >
    PQL Scoring System — Scalable Automation. Identify high-intent users for sales outreach based on
...
outcome: "≥65% at 500+"
kpis: ["PQL identification", "Score accuracy", "Sales conversion", "Segment metrics"]
...
## Overview
PQL Scoring System — Scalable Automation. Identify high-intent users for sales outreach based on product usage signals.
