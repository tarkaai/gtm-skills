...
description: >
    PQL Scoring System — Durable Intelligence. Identify high-intent users for sales outreach based
  on product usage signals.
stage: "Product > Onboard"
motion: "Lead Capture Surface"
channels: "Product"
level: "Durable Intelligence"
time: "150 hours over 6 months"
outcome: "Sustained or improving accuracy ≥65% over 6 months via AI"
...
## Overview
PQL Scoring System — Durable Intelligence. Identify high-intent users for sales outreach based on product usage signals.

**Time commitment:** 150 hours over 6 months
**Pass threshold:** Sustained or improving accuracy ≥65% over 6 months via AI
...
Measure against: Sustained or improving accuracy ≥65% over 6 months via AI. This level runs continuously. If product metrics sustain or improve, the play is durable. If metrics decay, the agent diagnoses the cause and recommends interventions.
...
## Pass threshold
**Sustained or improving accuracy ≥65% over 6 months via AI**
