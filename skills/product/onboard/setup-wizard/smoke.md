...
description: >
    Guided Setup Wizard — Smoke Test. Multi-step wizard guiding users through complex initial
...
## Overview
Guided Setup Wizard — Smoke Test. Multi-step wizard guiding users through complex initial configuration with validation and progress tracking.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** ≥65% complete
...
Run the `threshold-engine` drill to measure against: ≥65% complete. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
