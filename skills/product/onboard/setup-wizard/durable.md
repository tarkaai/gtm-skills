...
description: >
    Guided Setup Wizard — Durable Intelligence. Multi-step wizard guiding users through complex
  initial configuration with validation and progress tracking.
stage: "Product > Onboard"
motion: "Lead Capture Surface"
channels: "Product"
level: "Durable Intelligence"
time: "150 hours over 6 months"
outcome: "Sustained or improving completion ≥70% over 6 months via AI"
...
## Overview
Guided Setup Wizard — Durable Intelligence. Multi-step wizard guiding users through complex initial configuration with validation and progress tracking.

**Time commitment:** 150 hours over 6 months
**Pass threshold:** Sustained or improving completion ≥70% over 6 months via AI
...
Measure against: Sustained or improving completion ≥70% over 6 months via AI. This level runs continuously. If product metrics sustain or improve, the play is durable. If metrics decay, the agent diagnoses the cause and recommends interventions.
...
## Pass threshold
**Sustained or improving completion ≥70% over 6 months via AI**
...
_Install this skill: `npx gtm-skills add product/onboard/setup-wizard`_
