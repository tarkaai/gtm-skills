...
description: >
    Onboarding Checklist Workflow — Smoke Test. Step-by-step checklist guiding users through
...
Run the `threshold-engine` drill to measure against: ≥60% complete in 7d. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
