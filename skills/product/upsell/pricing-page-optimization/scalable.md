...
description: >
    Self-Serve Pricing Optimization — Scalable Automation. Test pricing page to increase self-serve
...
kpis: ["Conversion rate", "Plan mix", "ARPU", "Segment metrics"]
...
## Overview
Self-Serve Pricing Optimization — Scalable Automation. Test pricing page to increase self-serve conversions and plan selection.
