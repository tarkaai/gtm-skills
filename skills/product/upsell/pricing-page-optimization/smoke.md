...
description: >
    Self-Serve Pricing Optimization — Smoke Test. Test pricing page to increase self-serve
...
## Overview
Self-Serve Pricing Optimization — Smoke Test. Test pricing page to increase self-serve conversions and plan selection.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** ≥5% lift from test
...
Run the `threshold-engine` drill to measure against: ≥5% lift from test. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
