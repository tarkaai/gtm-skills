...
description: >
    Related Product Cross-Sell — Smoke Test. Promote related products in-app to existing customers
...
## Overview
Related Product Cross-Sell — Smoke Test. Promote related products in-app to existing customers for portfolio expansion.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** ≥10% adopt 2nd product
...
Run the `threshold-engine` drill to measure against: ≥10% adopt 2nd product. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
