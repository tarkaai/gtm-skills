...
description: >
    Module Cross-Sell — Scalable Automation. Showcase add-ons and modules in-product to drive
...
## Overview
Module Cross-Sell — Scalable Automation. Showcase add-ons and modules in-product to drive cross-sell and increase ARPU.

**Time commitment:** 60 hours over 2 months
**Pass threshold:** ≥20% at 500+
...
Measure against: ≥20% at 500+. If PASS, proceed to Durable. If FAIL, focus on the highest-impact experiment and iterate.
