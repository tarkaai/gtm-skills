...
description: >
    Automatic Usage Upsell — Durable Intelligence. Automatically upgrade users as usage grows based
...
outcome: "Sustained or improving acceptance ≥55% over 6 months via AI"
...
## Overview
Automatic Usage Upsell — Durable Intelligence. Automatically upgrade users as usage grows based on consumption thresholds.

**Time commitment:** 150 hours over 6 months
**Pass threshold:** Sustained or improving acceptance ≥55% over 6 months via AI
...
Measure against: Sustained or improving acceptance ≥55% over 6 months via AI. This level runs continuously. If product metrics sustain or improve, the play is durable. If metrics decay, the agent diagnoses the cause and recommends interventions.
...
## Pass threshold
**Sustained or improving acceptance ≥55% over 6 months via AI**
