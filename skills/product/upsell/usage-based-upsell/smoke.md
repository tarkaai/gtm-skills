...
description: >
    Automatic Usage Upsell — Smoke Test. Automatically upgrade users as usage grows based on
...
outcome: "≥50% accept auto-upgrade"
...
## Overview
Automatic Usage Upsell — Smoke Test. Automatically upgrade users as usage grows based on consumption thresholds.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** ≥50% accept auto-upgrade
...
Run the `threshold-engine` drill to measure against: ≥50% accept auto-upgrade. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
