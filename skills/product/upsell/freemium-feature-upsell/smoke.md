...
description: >
    Freemium to Paid Conversion — Smoke Test. Showcase premium features to free users to drive
  upgrade conversions.
...
## Overview
Freemium to Paid Conversion — Smoke Test. Showcase premium features to free users to drive upgrade conversions.
...
Run the `threshold-engine` drill to measure against: ≥5% free to paid. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
