...
description: >
    Free to Paid Funnel — Smoke Test. Optimize funnel from free signup to paid conversion with
...
Run the `threshold-engine` drill to measure against: ≥6% convert. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
