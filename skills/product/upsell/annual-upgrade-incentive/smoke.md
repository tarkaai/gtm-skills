...
description: >
    Monthly to Annual Conversion — Smoke Test. Offer discounts to convert monthly subscribers to
...
Run the `threshold-engine` drill to measure against: ≥20% convert. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
