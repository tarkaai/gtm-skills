---
name: free-trial-extension-smoke
description: >
    Strategic Trial Extensions — Smoke Test. Offer extended trial to engaged users close to
...
outcome: "≥40% convert after extension"
...
## Overview
Strategic Trial Extensions — Smoke Test. Offer extended trial to engaged users close to conversion to close more deals.

**Time commitment:** 5 hours over 1 week
**Pass threshold:** ≥40% convert after extension
...
Run the `threshold-engine` drill to measure against: ≥40% convert after extension. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
