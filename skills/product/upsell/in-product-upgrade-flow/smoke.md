...
description: >
    Self-Serve Upgrade UX — Smoke Test. Self-serve upgrade without sales involvement for
...
Run the `threshold-engine` drill to measure against: ≥60% self-serve. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
