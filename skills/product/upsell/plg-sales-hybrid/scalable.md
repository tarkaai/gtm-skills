...
description: >
    PLG + Sales-Assist Model — Scalable Automation. Combine self-serve with sales-assist for
...
outcome: "≥45% convert at 500+"
kpis: ["Sales-assist rate", "Sales conversion", "ACV lift", "Segment metrics"]
...
## Overview
PLG + Sales-Assist Model — Scalable Automation. Combine self-serve with sales-assist for high-value accounts and complex deals.

**Time commitment:** 60 hours over 2 months
**Pass threshold:** ≥45% convert at 500+
...
Measure against: ≥45% convert at 500+. If PASS, proceed to Durable. If FAIL, focus on the highest-impact experiment and iterate.
