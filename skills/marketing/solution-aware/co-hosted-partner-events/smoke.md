...
description: >
    Co-hosted Partner Events — Smoke Test. Partner on field events, dinners, or conferences to share
  costs, combine audiences, and generate qualified leads from solution-aware attendees.
stage: "Marketing > Solution Aware"
motion: "Micro Events"
channels: "Events"
level: "Smoke Test"
time: "6 hours over 1 week"
outcome: "≥30 attendees and ≥5 qualified leads from first co-hosted event"
...
## Overview
Co-hosted Partner Events — Smoke Test. Partner on field events, dinners, or conferences to share costs, combine audiences, and generate qualified leads from solution-aware attendees.

**Time commitment:** 6 hours over 1 week
**Pass threshold:** ≥30 attendees and ≥5 qualified leads from first co-hosted event
...
Run the `threshold-engine` drill to measure against: ≥30 attendees and ≥5 qualified leads from first co-hosted event. If PASS, proceed to Baseline. If FAIL, adjust event topic, format, promotion channels, or timing.
...
## Pass threshold
**≥30 attendees and ≥5 qualified leads from first co-hosted event**
