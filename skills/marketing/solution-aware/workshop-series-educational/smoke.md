...
description: >
    Workshop Series — Smoke Test. Run educational workshops teaching relevant skills or frameworks
...
outcome: "≥15 attendees and ≥5 qualified leads from first workshop"
...
## Overview
Workshop Series — Smoke Test. Run educational workshops teaching relevant skills or frameworks to generate leads, demonstrate expertise, and engage solution-aware audiences hands-on.

**Time commitment:** 6 hours over 1 week
**Pass threshold:** ≥15 attendees and ≥5 qualified leads from first workshop
...
Run the `threshold-engine` drill to measure against: ≥15 attendees and ≥5 qualified leads from first workshop. If PASS, proceed to Baseline. If FAIL, adjust event topic, format, promotion channels, or timing.
...
## Pass threshold
**≥15 attendees and ≥5 qualified leads from first workshop**
