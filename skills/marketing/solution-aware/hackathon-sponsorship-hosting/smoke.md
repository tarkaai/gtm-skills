...
description: >
    Hackathon Sponsorship — Smoke Test. Sponsor or host hackathons to engage developer audience,
...
outcome: "≥50 developer attendees and ≥5 qualified leads from first hackathon"
...
## Overview
Hackathon Sponsorship — Smoke Test. Sponsor or host hackathons to engage developer audience, showcase product capabilities, and generate qualified technical leads.

**Time commitment:** 6 hours over 1 week
**Pass threshold:** ≥50 developer attendees and ≥5 qualified leads from first hackathon
...
Run the `threshold-engine` drill to measure against: ≥50 developer attendees and ≥5 qualified leads from first hackathon. If PASS, proceed to Baseline. If FAIL, adjust event topic, format, promotion channels, or timing.
...
## Pass threshold
**≥50 developer attendees and ≥5 qualified leads from first hackathon**
