...
description: >
    Partner Marketplace Listings — Smoke Test. Get listed in partner app marketplaces (Salesforce
  AppExchange, HubSpot, Shopify) to drive discovery and leads from solution-aware users of those
  platforms.
...
outcome: "≥1 marketplace listing and ≥5 marketplace-sourced leads in 4 weeks"
...
## Overview
Partner Marketplace Listings — Smoke Test. Get listed in partner app marketplaces (Salesforce AppExchange, HubSpot, Shopify) to drive discovery and leads from solution-aware users of those platforms.

**Time commitment:** 6 hours over 1 week
**Pass threshold:** ≥1 marketplace listing and ≥5 marketplace-sourced leads in 4 weeks
...
Run the `threshold-engine` drill to measure against: ≥1 marketplace listing and ≥5 marketplace-sourced leads in 4 weeks. If PASS, proceed to Baseline. If FAIL, improve listing copy or target different directories.
...
## Pass threshold
**≥1 marketplace listing and ≥5 marketplace-sourced leads in 4 weeks**
