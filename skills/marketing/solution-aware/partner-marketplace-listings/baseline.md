...
description: >
    Partner Marketplace Listings — Baseline Run. Get listed in partner app marketplaces (Salesforce
...
Run the `posthog-gtm-events` drill to track: `partner-marketplace-listings_listing_view`, `partner-marketplace-listings_listing_click`, `partner-marketplace-listings_listing_signup`, `partner-marketplace-listings_review_submitted`. Use UTM parameters per directory for attribution.
...
Measure against: ≥3 marketplace listings and ≥20 marketplace leads in 8 weeks. If PASS, proceed to Scalable. If FAIL, focus on the directories driving the most qualified traffic.
