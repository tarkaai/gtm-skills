...
description: >
  Outbound Referral Requests — Durable Intelligence. Ask existing customers and contacts for warm introductions to specific target accounts to generate high-quality solution-aware leads through trusted networks.
stage: "Marketing > Solution Aware"
motion: "Partnerships & Warm Intros"
channels: "Email, Direct"
level: "Durable Intelligence"
time: "180 hours over 12 months"
outcome: "Sustained referral rate (≥12%) over 12 months via AI-driven relationship mapping and ask optimization"
...
## Overview
Ask existing customers and contacts for warm introductions to specific target accounts to generate high-quality solution-aware leads through trusted networks.

**Time commitment:** 180 hours over 12 months
**Pass threshold:** Sustained referral rate (≥12%) over 12 months via AI-driven relationship mapping and ask optimization
...
1. Deploy AI-powered intelligence system in n8n: analyze PostHog data to identify patterns predicting success and failure in outbound referral requests campaigns.
...
## Pass threshold
**Sustained referral rate (≥12%) over 12 months via AI-driven relationship mapping and ask optimization**
