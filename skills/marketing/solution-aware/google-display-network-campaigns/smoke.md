...
description: >
    Google Display Network — Smoke Test. Run GDN campaigns targeting in-market audiences and
...
Run the `threshold-engine` drill to measure against: ≥30,000 impressions and ≥5 qualified leads from $300 GDN test. If PASS, proceed to Baseline. If FAIL, diagnose whether the issue is targeting (wrong audience), creative (low CTR), or landing page (low conversion).
