...
description: >
    Outbound Email/LI/Calls — Durable Intelligence. Send a short founder-sent sequence to 100 ICP
...
## Overview
Outbound Email/LI/Calls — Durable Intelligence. Send a short founder-sent sequence to 100 ICP contacts with Calendly to see if you get a positive reply rate or a couple of meetings in 7–10 days.
...
Run the `dashboard-builder` drill to create a PostHog dashboard for outbound-email-li-calls with panels: weekly send volume, reply rate trend, meeting conversion rate, pipeline value from this play, cost per meeting. Set up alerts for when any metric drops below the Scalable-level baseline by more than 20%.
