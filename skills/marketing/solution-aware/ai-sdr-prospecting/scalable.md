...
description: >
    AI SDR Prospecting — Scalable Automation. Use AI SDR tools to automate prospect research, list
...
outcome: "≥1.6% meeting rate at 1,000 contacts/week over 3 months"
...
## Overview
AI SDR Prospecting — Scalable Automation. Use AI SDR tools to automate prospect research, list building, and initial outreach at scale for solution-aware B2B prospects.

**Time commitment:** 75 hours over 3 months
**Pass threshold:** ≥1.6% meeting rate at 1,000 contacts/week over 3 months
...
Measure against: ≥1.6% meeting rate at 1,000 contacts/week over 3 months. Review A/B test results to identify winning variants. If PASS, proceed to Durable. If FAIL, focus on the lowest-performing stage in the funnel and run targeted experiments.
...
## Pass threshold
**≥1.6% meeting rate at 1,000 contacts/week over 3 months**
