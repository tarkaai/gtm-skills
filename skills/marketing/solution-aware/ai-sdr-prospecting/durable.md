...
description: >
    AI SDR Prospecting — Durable Intelligence. Use AI SDR tools to automate prospect research, list
  building, and initial outreach at scale for solution-aware B2B prospects.
stage: "Marketing > Solution Aware"
motion: "Outbound Founder-Led"
channels: "Email, Social"
level: "Durable Intelligence"
time: "180 hours over 12 months"
outcome: "Sustained meeting rate (≥1.6%) over 12 months via AI-driven personalization and continuous learning"
...
## Overview
AI SDR Prospecting — Durable Intelligence. Use AI SDR tools to automate prospect research, list building, and initial outreach at scale for solution-aware B2B prospects.

**Time commitment:** 180 hours over 12 months
**Pass threshold:** Sustained meeting rate (≥1.6%) over 12 months via AI-driven personalization and continuous learning
...
Run the `dashboard-builder` drill to create a PostHog dashboard for ai-sdr-prospecting with panels: weekly send volume, reply rate trend, meeting conversion rate, pipeline value from this play, cost per meeting. Set up alerts for when any metric drops below the Scalable-level baseline by more than 20%.
...
Measure against: Sustained meeting rate (≥1.6%) over 12 months via AI-driven personalization and continuous learning. This level runs continuously. If metrics sustain or improve, the play is durable. If metrics decay, diagnose whether the issue is market saturation, message fatigue, or ICP drift.
...
## Pass threshold
**Sustained meeting rate (≥1.6%) over 12 months via AI-driven personalization and continuous learning**
