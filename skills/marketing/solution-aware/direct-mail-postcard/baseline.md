...
1. Define your 2-week experiment scope: list size, channels, and success criteria aligned with your pass threshold (e.g. ≥ 5 inbound leads or ≥ 2 meetings over 2 weeks).
...
5. Log every outcome in PostHog: track Response rate, Inbound inquiries so you can compute rates and compare to threshold.
