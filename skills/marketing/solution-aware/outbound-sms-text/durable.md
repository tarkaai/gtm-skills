...
description: >
    SMS Outbound Sequences — Durable Intelligence. Text-based outreach sequences for mobile-first
  prospects to complement email and increase touchpoint diversity with solution-aware buyers.
stage: "Marketing > Solution Aware"
motion: "Outbound Founder-Led"
channels: "Direct"
level: "Durable Intelligence"
time: "180 hours over 12 months"
outcome: "Sustained SMS conversion (≥3%) over 12 months via AI-optimized messaging and timing"
...
## Overview
SMS Outbound Sequences — Durable Intelligence. Text-based outreach sequences for mobile-first prospects to complement email and increase touchpoint diversity with solution-aware buyers.

**Time commitment:** 180 hours over 12 months
**Pass threshold:** Sustained SMS conversion (≥3%) over 12 months via AI-optimized messaging and timing
...
Run the `dashboard-builder` drill to create a PostHog dashboard for outbound-sms-text with panels: weekly send volume, reply rate trend, meeting conversion rate, pipeline value from this play, cost per meeting. Set up alerts for when any metric drops below the Scalable-level baseline by more than 20%.
...
Measure against: Sustained SMS conversion (≥3%) over 12 months via AI-optimized messaging and timing. This level runs continuously. If metrics sustain or improve, the play is durable. If metrics decay, diagnose whether the issue is market saturation, message fatigue, or ICP drift.
...
## Pass threshold
**Sustained SMS conversion (≥3%) over 12 months via AI-optimized messaging and timing**
