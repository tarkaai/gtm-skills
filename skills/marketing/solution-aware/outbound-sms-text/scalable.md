...
description: >
    SMS Outbound Sequences — Scalable Automation. Text-based outreach sequences for mobile-first
...
## Overview
SMS Outbound Sequences — Scalable Automation. Text-based outreach sequences for mobile-first prospects to complement email and increase touchpoint diversity with solution-aware buyers.

**Time commitment:** 75 hours over 3 months
**Pass threshold:** ≥3% response rate at 800 SMS/month over 3 months
...
Measure against: ≥3% response rate at 800 SMS/month over 3 months. Review A/B test results to identify winning variants. If PASS, proceed to Durable. If FAIL, focus on the lowest-performing stage in the funnel and run targeted experiments.
...
## Pass threshold
**≥3% response rate at 800 SMS/month over 3 months**
