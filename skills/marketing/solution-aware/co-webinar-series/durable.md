...
- **Partner replacement**: When a partner is retired, the agent triggers the the co webinar partner matching workflow (see instructions below) drill to source a replacement. Maintain 6+ active partners and 10+ prospects in the pipeline.
