...
description: >
    Micro-Roundtable — Scalable Automation. Host an invite-only Zoom roundtable with 8–10 execs to
...
Measure against: ≥ 40 attendees and ≥ 16 meetings over 2 months. If PASS, proceed to Durable. If FAIL, reduce frequency and focus on the event format that converts best.
