...
1. Define your 2-week experiment scope: list size, channels, and success criteria aligned with your pass threshold (e.g. ≥ 12 attendees and ≥ 4 meetings over 2 weeks).
...
5. Log every outcome in PostHog: track RSVPs, Show rate so you can compute rates and compare to threshold.
