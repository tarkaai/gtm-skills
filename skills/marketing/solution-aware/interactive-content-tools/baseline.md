...
description: >
    Interactive Content Tools — Baseline Run. Create calculators, assessments, and ROI tools that
...
Run the `posthog-gtm-events` drill to set up detailed tracking: `interactive-content-tools_impression`, `interactive-content-tools_engaged`, `interactive-content-tools_converted`, `interactive-content-tools_retained`. Build PostHog funnels showing the complete user journey through this experience.
...
Measure against: ≥300 completions and ≥100 qualified leads over 6 weeks. If PASS, proceed to Scalable. If FAIL, diagnose where users are dropping off and test fixes at that specific point.
