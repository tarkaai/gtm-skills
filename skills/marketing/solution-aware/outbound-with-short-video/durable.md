...
description: >
    Outbound With Short Video — Durable Intelligence. Send a batch of personalized short videos to
  prospects to test if video increases watch rate and meetings versus text-only.
stage: "Marketing > Solution Aware"
motion: "Outbound Founder-Led"
channels: "Email"
level: "Durable Intelligence"
time: "200 hours over 6 months"
outcome: "Sustained or improving completion and meetings over 6 months via continuous agent-driven experiments and adaptation to market changes; agents learn and tune workflows to stay aligned with or exceed Scalable baseline."
...
## Overview
Outbound With Short Video — Durable Intelligence. Send a batch of personalized short videos to prospects to test if video increases watch rate and meetings versus text-only.

**Time commitment:** 200 hours over 6 months
**Pass threshold:** Sustained or improving completion and meetings over 6 months via continuous agent-driven experiments and adaptation to market changes; agents learn and tune workflows to stay aligned with or exceed Scalable baseline.
...
Run the `dashboard-builder` drill to create a PostHog dashboard for outbound-with-short-video with panels: weekly send volume, reply rate trend, meeting conversion rate, pipeline value from this play, cost per meeting. Set up alerts for when any metric drops below the Scalable-level baseline by more than 20%.
...
## Pass threshold
**Sustained or improving completion and meetings over 6 months via continuous agent-driven experiments and adaptation to market changes; agents learn and tune workflows to stay aligned with or exceed Scalable baseline.**
