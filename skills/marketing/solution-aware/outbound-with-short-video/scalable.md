...
description: >
    Outbound With Short Video — Scalable Automation. Send a batch of personalized short videos to
...
Measure against: ≥ 10% completion and ≥ 8 meetings over 2 months. Review A/B test results to identify winning variants. If PASS, proceed to Durable. If FAIL, focus on the lowest-performing stage in the funnel and run targeted experiments.
