...
description: >
    Technical SEO Audit & Fix — Smoke Test. Systematically audit and fix technical SEO issues to
...
outcome: "Improve Core Web Vitals by 20% and reduce critical errors to zero"
...
## Overview
Technical SEO Audit & Fix — Smoke Test. Systematically audit and fix technical SEO issues to improve search rankings, organic traffic, and lead generation from solution-aware searchers.

**Time commitment:** 6 hours over 1 week
**Pass threshold:** Improve Core Web Vitals by 20% and reduce critical errors to zero
...
Run the `threshold-engine` drill to measure against: Improve Core Web Vitals by 20% and reduce critical errors to zero. If PASS, proceed to Baseline. If FAIL, simplify the experience or target a different user action.
...
## Pass threshold
**Improve Core Web Vitals by 20% and reduce critical errors to zero**
