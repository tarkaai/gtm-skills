...
1. Define your 2-week experiment scope: list size, channels, and success criteria aligned with your pass threshold (e.g. ≤$800 cost per meeting over 2 weeks).
...
5. Log every outcome in PostHog: track Click-through rate, Landing page conversion rate so you can compute rates and compare to threshold.
