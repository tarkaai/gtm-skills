...
description: >
    LinkedIn Video DMs — Scalable Automation. Send personalized video direct messages on LinkedIn
...
## Overview
LinkedIn Video DMs — Scalable Automation. Send personalized video direct messages on LinkedIn for higher engagement than text-based outreach with solution-aware B2B prospects.

**Time commitment:** 75 hours over 3 months
**Pass threshold:** ≥8% response rate at 300 video DMs/month over 3 months
...
Measure against: ≥8% response rate at 300 video DMs/month over 3 months. Review A/B test results to identify winning variants. If PASS, proceed to Durable. If FAIL, focus on the lowest-performing stage in the funnel and run targeted experiments.
...
## Pass threshold
**≥8% response rate at 300 video DMs/month over 3 months**
