...
description: >
    Regional Field Events — Smoke Test. Host dinners, happy hours, or lunches in key markets to
...
outcome: "≥20 attendees and ≥5 qualified leads from first event"
...
## Overview
Regional Field Events — Smoke Test. Host dinners, happy hours, or lunches in key markets to build relationships and generate pipeline with solution-aware and product-aware local prospects.

**Time commitment:** 6 hours over 1 week
**Pass threshold:** ≥20 attendees and ≥5 qualified leads from first event
...
Run the `threshold-engine` drill to measure against: ≥20 attendees and ≥5 qualified leads from first event. If PASS, proceed to Baseline. If FAIL, adjust event topic, format, promotion channels, or timing.
...
## Pass threshold
**≥20 attendees and ≥5 qualified leads from first event**
