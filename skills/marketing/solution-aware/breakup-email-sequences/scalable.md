...
description: >
    Breakup Email Sequences — Scalable Automation. Final 'we're moving on' emails to re-engage cold
...
outcome: "≥6% response rate at 800 breakup emails/month over 3 months"
...
## Overview
Breakup Email Sequences — Scalable Automation. Final 'we're moving on' emails to re-engage cold prospects and elicit responses from solution-aware leads who went silent in outbound sequences.

**Time commitment:** 75 hours over 3 months
**Pass threshold:** ≥6% response rate at 800 breakup emails/month over 3 months
...
Measure against: ≥6% response rate at 800 breakup emails/month over 3 months. Review A/B test results to identify winning variants. If PASS, proceed to Durable. If FAIL, focus on the lowest-performing stage in the funnel and run targeted experiments.
...
## Pass threshold
**≥6% response rate at 800 breakup emails/month over 3 months**
