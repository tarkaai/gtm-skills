...
description: >
    Breakup Email Sequences — Durable Intelligence. Final 'we're moving on' emails to re-engage cold
  prospects and elicit responses from solution-aware leads who went silent in outbound sequences.
stage: "Marketing > Solution Aware"
motion: "Outbound Founder-Led"
channels: "Email"
level: "Durable Intelligence"
time: "180 hours over 12 months"
outcome: "Sustained breakup effectiveness (≥6%) over 12 months via AI-optimized messaging and timing"
...
## Overview
Breakup Email Sequences — Durable Intelligence. Final 'we're moving on' emails to re-engage cold prospects and elicit responses from solution-aware leads who went silent in outbound sequences.

**Time commitment:** 180 hours over 12 months
**Pass threshold:** Sustained breakup effectiveness (≥6%) over 12 months via AI-optimized messaging and timing
...
Run the `dashboard-builder` drill to create a PostHog dashboard for breakup-email-sequences with panels: weekly send volume, reply rate trend, meeting conversion rate, pipeline value from this play, cost per meeting. Set up alerts for when any metric drops below the Scalable-level baseline by more than 20%.
...
Measure against: Sustained breakup effectiveness (≥6%) over 12 months via AI-optimized messaging and timing. This level runs continuously. If metrics sustain or improve, the play is durable. If metrics decay, diagnose whether the issue is market saturation, message fatigue, or ICP drift.
...
## Pass threshold
**Sustained breakup effectiveness (≥6%) over 12 months via AI-optimized messaging and timing**
