...
description: >
    Account-based Cold Calling — Scalable Automation. Targeted call campaigns to specific high-value
...
outcome: "≥2.5% call-to-meeting rate at 500 calls/month over 3 months"
...
## Overview
Account-based Cold Calling — Scalable Automation. Targeted call campaigns to specific high-value accounts with personalized research to generate meetings with solution-aware decision makers.

**Time commitment:** 75 hours over 3 months
**Pass threshold:** ≥2.5% call-to-meeting rate at 500 calls/month over 3 months
...
Measure against: ≥2.5% call-to-meeting rate at 500 calls/month over 3 months. Review A/B test results to identify winning variants. If PASS, proceed to Durable. If FAIL, focus on the lowest-performing stage in the funnel and run targeted experiments.
...
## Pass threshold
**≥2.5% call-to-meeting rate at 500 calls/month over 3 months**
