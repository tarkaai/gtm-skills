...
description: >
    Trigger-based Outreach — Scalable Automation. Automate outreach based on intent signals like
  funding, hiring, tech stack changes, or job changes to reach solution-aware prospects at optimal
  timing.
...
outcome: "≥3% meeting rate at 500 trigger-based contacts/month over 3 months"
...
## Overview
Trigger-based Outreach — Scalable Automation. Automate outreach based on intent signals like funding, hiring, tech stack changes, or job changes to reach solution-aware prospects at optimal timing.

**Time commitment:** 75 hours over 3 months
**Pass threshold:** ≥3% meeting rate at 500 trigger-based contacts/month over 3 months
...
Measure against: ≥3% meeting rate at 500 trigger-based contacts/month over 3 months. Review A/B test results to identify winning variants. If PASS, proceed to Durable. If FAIL, focus on the lowest-performing stage in the funnel and run targeted experiments.
...
## Pass threshold
**≥3% meeting rate at 500 trigger-based contacts/month over 3 months**
