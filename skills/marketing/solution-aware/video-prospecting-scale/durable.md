...
description: >
    Video Prospecting at Scale — Durable Intelligence. Create personalized video messages for
  prospects using AI tools to increase engagement and response rates in outbound campaigns targeting
...
outcome: "Sustained video engagement (≥5%) over 12 months via AI-generated personalization at scale"
...
## Overview
Video Prospecting at Scale — Durable Intelligence. Create personalized video messages for prospects using AI tools to increase engagement and response rates in outbound campaigns targeting solution-aware audiences.

**Time commitment:** 180 hours over 12 months
**Pass threshold:** Sustained video engagement (≥5%) over 12 months via AI-generated personalization at scale
...
Run the `dashboard-builder` drill to create a PostHog dashboard for video-prospecting-scale with panels: weekly send volume, reply rate trend, meeting conversion rate, pipeline value from this play, cost per meeting. Set up alerts for when any metric drops below the Scalable-level baseline by more than 20%.
...
Measure against: Sustained video engagement (≥5%) over 12 months via AI-generated personalization at scale. This level runs continuously. If metrics sustain or improve, the play is durable. If metrics decay, diagnose whether the issue is market saturation, message fatigue, or ICP drift.
...
## Pass threshold
**Sustained video engagement (≥5%) over 12 months via AI-generated personalization at scale**
