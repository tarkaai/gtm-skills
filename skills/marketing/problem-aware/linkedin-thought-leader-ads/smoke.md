...
description: >
    Thought Leader Ads — Smoke Test. Promote founder or executive posts as LinkedIn ads to extend
...
Run the `threshold-engine` drill to measure against: ≥5,000 impressions and ≥5 qualified leads from $200 test budget. If PASS, proceed to Baseline. If FAIL, diagnose whether the issue is targeting (wrong audience), creative (low CTR), or landing page (low conversion).
