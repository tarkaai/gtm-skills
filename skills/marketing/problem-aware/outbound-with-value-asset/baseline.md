...
1. Define your 2-week experiment scope: list size, channels, and success criteria aligned with your pass threshold (e.g. ≥ 5 positive replies referencing asset over 2 weeks).
...
5. Log every outcome in PostHog: track Reply rate, Open rate so you can compute rates and compare to threshold.
