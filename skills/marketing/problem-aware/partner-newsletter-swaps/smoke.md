...
description: >
    Partner Newsletter Swaps — Smoke Test. Exchange newsletter mentions with complementary companies
  to reach new audiences and generate awareness with problem-aware and solution-aware subscribers.
...
Run the `threshold-engine` drill to measure against: ≥2 newsletter swaps and ≥100 new subscribers in 3 weeks. If PASS, proceed to Baseline. If FAIL, adjust your partner ICP or value proposition.
