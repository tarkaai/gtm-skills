...
description: >
    Paid Social Ads — Baseline Run. Run a capped spend across a couple of ad groups and one LP to
  see if you get first conversions or a meeting within budget.
...
Run the `posthog-gtm-events` drill to set up end-to-end tracking: `paid-social-ads_ad_click`, `paid-social-ads_landing_page_view`, `paid-social-ads_form_submit`, `paid-social-ads_lead_qualified`. Connect ad platform data to PostHog via webhooks for unified reporting.
