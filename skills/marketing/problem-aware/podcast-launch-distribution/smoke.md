...
description: >
    Branded Podcast Launch — Smoke Test. Launch and distribute a branded podcast to build awareness,
  generate inbound interest, and establish thought leadership with problem-aware and solution-aware
  audiences.
...
## Overview
Branded Podcast Launch — Smoke Test. Launch and distribute a branded podcast to build awareness, generate inbound interest, and establish thought leadership with problem-aware and solution-aware audiences.

**Time commitment:** 6 hours over 1 week
**Pass threshold:** ≥100 downloads and ≥2 inbound leads from first 3 episodes
...
Run the `threshold-engine` drill to measure results against: ≥100 downloads and ≥2 inbound leads from first 3 episodes. If PASS, proceed to Baseline. If FAIL, adjust your content topics, hooks, or posting frequency and re-run.
...
## Pass threshold
**≥100 downloads and ≥2 inbound leads from first 3 episodes**
