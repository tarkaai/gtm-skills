...
1. Define your 2-week experiment scope: list size, channels, and success criteria aligned with your pass threshold (e.g. ≥ 10 demos and ≥ 2 meetings over 2 weeks).
...
5. Log every outcome in PostHog: track Conversations started, Follow-up requests so you can compute rates and compare to threshold.
