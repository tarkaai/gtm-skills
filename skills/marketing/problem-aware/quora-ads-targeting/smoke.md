...
description: >
    Quora Ads — Smoke Test. Run answer-based ads on Quora targeting specific questions and topics to
  reach problem-aware and solution-aware audiences actively seeking solutions.
...
Run the `threshold-engine` drill to measure against: ≥10,000 impressions and ≥5 qualified leads from $200 Quora test. If PASS, proceed to Baseline. If FAIL, diagnose whether the issue is targeting (wrong audience), creative (low CTR), or landing page (low conversion).
