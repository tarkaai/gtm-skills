...
description: >
  GitHub Sample or Teaser — Durable Intelligence. Publish a public repo with a README CTA to test whether devs or technical audiences engage and at least one lead comes through.
stage: "Marketing > Problem Aware"
motion: "Directories & Marketplaces"
channels: "Other"
level: "Durable Intelligence"
time: "200 hours over 6 months"
outcome: "Sustained or improving stars or ,000 visitors and leads over 6 months via continuous agent-driven experiments and adaptation to market changes; agents learn and tune workflows to stay aligned with or exceed Scalable baseline."
...
**Pass threshold:** Sustained or improving stars or ,000 visitors and leads over 6 months via continuous agent-driven experiments and adaptation to market changes; agents learn and tune workflows to stay aligned with or exceed Scalable baseline.
...
1. Ensure PostHog is receiving events from all your tools so you have a single view of performance over time; create a dashboard for Repository views, Clone or download rate.
...
## Pass threshold
**Sustained or improving stars or ,000 visitors and leads over 6 months via continuous agent-driven experiments and adaptation to market changes; agents learn and tune workflows to stay aligned with or exceed Scalable baseline.**
