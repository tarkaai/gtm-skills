...
1. Define your 2-week experiment scope: list size, channels, and success criteria aligned with your pass threshold (e.g. ≥ 50 stars or ≥ 300 visitors and ≥ 3 leads over 2 weeks).
...
5. Log every outcome in PostHog: track Repository views, Clone or download rate so you can compute rates and compare to threshold.
