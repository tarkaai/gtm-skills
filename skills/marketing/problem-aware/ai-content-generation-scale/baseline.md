...
description: >
    AI Content Generation — Baseline Run. Use AI to create high-quality blog posts, guides, and
...
Run the `posthog-gtm-events` drill to track content performance events: `ai-content-generation-scale_post_published`, `ai-content-generation-scale_engagement_received`, `ai-content-generation-scale_profile_visit`, `ai-content-generation-scale_dm_received`, `ai-content-generation-scale_lead_captured`. Connect social platform analytics to PostHog via n8n webhooks.
...
Review PostHog data against: ≥2,000 page views and ≥20 conversions over 6 weeks. If PASS, proceed to Scalable. If FAIL, pivot content topics or try different formats (video, carousels, threads vs single posts).
