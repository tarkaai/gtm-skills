...
description: >
    YouTube Pre-roll Ads — Baseline Run. Run video ads on YouTube targeting specific channels or
  topics to build awareness and generate interest with problem-aware and solution-aware audiences.
...
## Overview
YouTube Pre-roll Ads — Baseline Run. Run video ads on YouTube targeting specific channels or topics to build awareness and generate interest with problem-aware and solution-aware audiences.

**Time commitment:** 18 hours over 2 weeks
**Pass threshold:** ≥100,000 views and ≥15 qualified leads from $2,000 budget over 3 weeks
...
Run the `posthog-gtm-events` drill to set up end-to-end tracking: `youtube-preroll-ads_ad_click`, `youtube-preroll-ads_landing_page_view`, `youtube-preroll-ads_form_submit`, `youtube-preroll-ads_lead_qualified`. Connect ad platform data to PostHog via webhooks for unified reporting.
...
Measure against: ≥100,000 views and ≥15 qualified leads from $2,000 budget over 3 weeks. If PASS, proceed to Scalable. If FAIL, test different audiences, creatives, or platforms.
...
## Pass threshold
**≥100,000 views and ≥15 qualified leads from $2,000 budget over 3 weeks**
