...
description: >
    YouTube Pre-roll Ads — Smoke Test. Run video ads on YouTube targeting specific channels or
...
outcome: "≥10,000 views and ≥3 qualified leads from $300 test budget"
...
## Overview
YouTube Pre-roll Ads — Smoke Test. Run video ads on YouTube targeting specific channels or topics to build awareness and generate interest with problem-aware and solution-aware audiences.

**Time commitment:** 6 hours over 1 week
**Pass threshold:** ≥10,000 views and ≥3 qualified leads from $300 test budget
...
Run the `threshold-engine` drill to measure against: ≥10,000 views and ≥3 qualified leads from $300 test budget. If PASS, proceed to Baseline. If FAIL, diagnose whether the issue is targeting (wrong audience), creative (low CTR), or landing page (low conversion).
