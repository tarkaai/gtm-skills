...
description: >
    YouTube Channel and SEO — Smoke Test. Create video content optimized for YouTube search and
...
Run the `threshold-engine` drill to measure results against: ≥500 views and ≥5 conversions in 4 weeks. If PASS, proceed to Baseline. If FAIL, adjust your content topics, hooks, or posting frequency and re-run.
