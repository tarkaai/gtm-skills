...
description: >
    Conference Speaking — Smoke Test. Secure speaking slots at industry conferences for brand
...
outcome: "≥1 speaking slot and ≥10 qualified leads from first conference"
...
## Overview
Conference Speaking — Smoke Test. Secure speaking slots at industry conferences for brand building, thought leadership, and lead generation with solution-aware and problem-aware attendees.

**Time commitment:** 6 hours over 1 week
**Pass threshold:** ≥1 speaking slot and ≥10 qualified leads from first conference
...
Run the `threshold-engine` drill to measure against: ≥1 speaking slot and ≥10 qualified leads from first conference. If PASS, proceed to Baseline. If FAIL, adjust event topic, format, promotion channels, or timing.
...
## Pass threshold
**≥1 speaking slot and ≥10 qualified leads from first conference**
