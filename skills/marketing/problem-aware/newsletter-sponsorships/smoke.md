...
description: >
    Newsletter Sponsorship — Smoke Test. Place a one-off blurb in a niche newsletter to test list
...
Run the `threshold-engine` drill to measure against: ≥ 20 clicks and ≥ 1 lead in 1 week. If PASS, proceed to Baseline. If FAIL, diagnose whether the issue is targeting (wrong audience), creative (low CTR), or landing page (low conversion).
