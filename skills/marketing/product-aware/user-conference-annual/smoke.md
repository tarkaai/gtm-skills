...
description: >
    Annual User Conference — Smoke Test. Host annual customer conference for community building,
...
outcome: "≥50 customer attendees and ≥5 expansion opportunities from first conference"
...
## Overview
Annual User Conference — Smoke Test. Host annual customer conference for community building, product launches, and upsell opportunities with product-aware customers and prospects.

**Time commitment:** 6 hours over 1 week
**Pass threshold:** ≥50 customer attendees and ≥5 expansion opportunities from first conference
...
Run the `threshold-engine` drill to measure against: ≥50 customer attendees and ≥5 expansion opportunities from first conference. If PASS, proceed to Baseline. If FAIL, adjust event topic, format, promotion channels, or timing.
...
## Pass threshold
**≥50 customer attendees and ≥5 expansion opportunities from first conference**
