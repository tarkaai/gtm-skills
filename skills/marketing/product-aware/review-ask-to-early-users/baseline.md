...
1. Define your 2-week experiment scope: list size, channels, and success criteria aligned with your pass threshold (e.g. ≥ 6 new reviews and ≥ 3 inbound leads over 2 weeks).
...
5. Log every outcome in PostHog: track 3 new reviews, 1 inbound so you can compute rates and compare to threshold.
