...
description: >
    Multi-platform Retargeting — Smoke Test. Retarget website visitors across LinkedIn, Facebook,
...
outcome: "≥3% CTR and ≥5 conversions from $200 retargeting test"
...
## Overview
Multi-platform Retargeting — Smoke Test. Retarget website visitors across LinkedIn, Facebook, and display networks to stay top-of-mind and convert product-aware prospects who showed intent.

**Time commitment:** 6 hours over 1 week
**Pass threshold:** ≥3% CTR and ≥5 conversions from $200 retargeting test
...
Run the `threshold-engine` drill to measure against: ≥3% CTR and ≥5 conversions from $200 retargeting test. If PASS, proceed to Baseline. If FAIL, diagnose whether the issue is targeting (wrong audience), creative (low CTR), or landing page (low conversion).
